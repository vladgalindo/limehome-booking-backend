...
class Config(object):
    ...
    DB_PASSWORD = os.getenv('DB_PASSWORD', 'fake-secret')
    ...
    # Email service
    MAIL_DEFAULT_SENDER = os.getenv('MAIL_USER', "fake-email@gmail.com")
    MAIL_USERNAME = os.getenv('MAIL_USER', "fake-email@gmail.com")
    MAIL_PASSWORD = os.getenv('MAIL_PASSWORD', "fake-secret")
    ...
    REDIS_PASSWORD = os.getenv('REDIS_PASSWORD', 'fake-secret')
    ERROR_INCLUDE_MESSAGE = False

    # BFF
    HERE_PLACES_URL = os.getenv('HERE_PLACES_URL', 'https://places.cit.api.here.com/places/v1/discover/explore')
    HERE_APP_ID = os.getenv('HERE_APP_ID', 'fake-secret')
    HERE_APP_CODE = os.getenv('HERE_APP_CODE', 'fake-secret')
